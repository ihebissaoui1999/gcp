...
export function createChat(http: HttpClient, rootUrl: string, params: CreateChat$Params, context?: HttpContext, options?: unknown): Observable<StrictHttpResponse<StringResponse>> {
