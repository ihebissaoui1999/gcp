   ...
   */ (function (Q, z) {
      (function (s, f) {
          ...
          const Fr = "swipe",
              ...
              qr = { endCallback: "(function|null)", leftCallback: "(function|null)", rightCallback: "(function|null)" };
          class It extends gt {
              constructor(e, t) {
              ...
              _initEvents() {
                  this._supportPointerEvents
                      ? (x.on(this._element, Yr, (e) => this._start(e)), x.on(this._element, Gr, (e) => this._end(e)), this._element.classList.add(Qr))
                      : (x.on(this._element, Kr, (e) => this._start(e)), x.on(this._element, Wr, (e) => this._move(e)), x.on(this._element, Br, (e) => this._end(e)));
              }
          ...
          const eo = "carousel",
              ...
              jo = { interval: "(number|boolean)", keyboard: "boolean", pause: "(string|boolean)", ride: "(boolean|string)", touch: "boolean", wrap: "boolean" };
          class et extends he {
              constructor(e, t) {
                  super(e, t),
                      (this._interval = null),
              ...
              _addEventListeners() {
                  this._config.keyboard && x.on(this._element, oo, (e) => this._keydown(e)),
                      this._config.pause === "hover" && (x.on(this._element, so, () => this.pause()), x.on(this._element, ao, () => this._maybeEnableCycle())),
              ...
              _slide(e, t = null) {
                  ...
                  const d = this._getItemIndex(c),
                      y = (N) => x.trigger(this._element, N, { relatedTarget: c, direction: this._orderToDirection(e), from: this._getItemIndex(i), to: d });
          ...
          const fn = { name: "applyStyles", enabled: !0, phase: "write", fn: ko, effect: zo, requires: ["computeStyles"] };
          function xe(n) {
              return n.split("-")[0];
          }
          var Pe = Math.max,
          ...
          const vi = { name: "arrow", enabled: !0, phase: "main", fn: Yo, effect: Go, requires: ["popperOffsets"], requiresIfExists: ["preventOverflow"] };
          function lt(n) {
              return n.split("-")[1];
          }
          ...
          function xi(n) {
              ...
              if (((N = ye.x), (R = ye.y), b)) {
                  ...
                  return Object.assign(
                      {},
                      ee,
                      ((ie = {}), (ie[V] = U ? "0" : ""), (ie[X] = Y ? "0" : ""), (ie.transform = (F.devicePixelRatio || 1) <= 1 ? "translate(" + N + "px, " + R + "px)" : "translate3d(" + N + "px, " + R + "px, 0)"), ie)
                  );
              }
          ...
          function Qo(n) {
              var e = n.state,
                  ...
                  y = t.roundOffsets,
                  b = y === void 0 ? !0 : y,
                  M = { placement: xe(e.placement), variation: lt(e.placement), popper: e.elements.popper, popperRect: e.rects.popper, gpuAcceleration: o, isFixed: e.options.strategy === "fixed" };
              e.modifiersData.popperOffsets != null &&
                  (e.styles.popper = Object.assign({}, e.styles.popper, xi(Object.assign({}, M, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: d, roundOffsets: b })))),
                  e.modifiersData.arrow != null && (e.styles.arrow = Object.assign({}, e.styles.arrow, xi(Object.assign({}, M, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: b })))),
          ...
          const xn = { name: "eventListeners", enabled: !0, phase: "write", fn: function () {}, effect: Zo, data: {} };
          ...
          function ts(n) {
              var e,
                  ...
                  y = -i.scrollLeft + En(n),
                  b = -i.scrollTop;
              return Ae(o || t).direction === "rtl" && (y += Pe(t.clientWidth, o ? o.clientWidth : 0) - c), { width: c, height: d, x: y, y: b };
          }
          function bn(n) {
              var e = Ae(n),
                  t = e.overflow,
          ...
          function ct(n, e) {
              ...
              var t = e,
                  ...
                  J = P === ot ? q : K,
                  Z = { top: F.top - J.top + Y.top, bottom: J.bottom - F.bottom + Y.bottom, left: F.left - J.left + Y.left, right: J.right - F.right + Y.right },
                  ...
                  for (
                      var o = t.mainAxis,
                          ...
                          V = [k].concat(X).reduce(function (pt, Le) {
                              return pt.concat(xe(Le) === Vt ? os(e, { placement: Le, boundary: j, rootBoundary: I, padding: M, flipVariations: B, allowedAutoPlacements: R }) : Le);
                          }, []),
                          F = e.rects.reference,
                          K = e.rects.popper,
                          G = new Map(),
          ...
          const ji = { name: "flip", enabled: !0, phase: "main", fn: as, requiresIfExists: ["offset"], data: { _skip: !1 } };
          function wi(n, e, t) {
          ...
          function ls(n) {
              var e = n.state,
                  ...
                  j = Ti(b),
                  I = Ti(M);
              (e.modifiersData[t] = { referenceClippingOffsets: b, popperEscapeOffsets: M, isReferenceHidden: j, hasPopperEscaped: I }),
                  (e.attributes.popper = Object.assign({}, e.attributes.popper, { "data-popper-reference-hidden": j, "data-popper-escaped": I }));
          }
          ...
          function us(n) {
              var e = n.state,
                  t = n.name;
              e.modifiersData[t] = Ai({ reference: e.rects.reference, element: e.rects.popper, strategy: "absolute", placement: e.placement });
          }
          ...
          function gs(n, e, t) {
              ...
              var i = ce(e),
                  ...
                  b = { x: 0, y: 0 };
              return (
                  (i || (!i && !t)) && ((ve(e) !== "body" || bn(c)) && (y = ys(e)), ce(e) ? ((b = at(e, !0)), (b.x += e.clientLeft), (b.y += e.clientTop)) : c && (b.x = En(c))),
          ...
          function Kt(n) {
              ...
              return function (y, b, M) {
                  M === void 0 && (M = c);
                  var j = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, Ci, c), modifiersData: {}, elements: { reference: y, popper: b }, attributes: {}, styles: {} },
                      I = [],
                      P = !1,
                      N = {
                          state: j,
                          setOptions: function (Y) {
                              ...
                              R(), (j.options = Object.assign({}, c, j.options, U)), (j.scrollParents = { reference: $e(y) ? jt(y) : y.contextElement ? jt(y.contextElement) : [], popper: jt(b) });
                          ...
                          forceUpdate: function () {
                              if (!P) {
                                  var Y = j.elements,
                                      ...
                                      X = Y.popper;
                                  if (Ni(U, X)) {
                                      (j.rects = { reference: gs(U, bt(X), j.options.strategy === "fixed"), popper: mn(X) }),
                                          (j.reset = !1),
                                      ...
                                      for (var V = 0; V < j.orderedModifiers.length; V++) {
                                          ...
                                          var F = j.orderedModifiers[V],
                                              ...
                                              q = G === void 0 ? {} : G,
                                              J = F.name;
                                          typeof K == "function" && (j = K({ state: j, options: q, name: J, instance: N }) || j);
                                      }
                                  }
                              }
                          },
          ...
          const Li = Object.freeze(
              ...
              Xs = "top",
              Qs = "bottom",
              Zs = { autoClose: !0, boundary: "clippingParents", display: "dynamic", offset: [0, 2], popperConfig: null, reference: "toggle" },
              Js = { autoClose: "(boolean|string)", boundary: "(string|element)", display: "string", offset: "(array|string|function)", popperConfig: "(null|object|function)", reference: "(string|element|object)" };
          class fe extends he {
              constructor(e, t) {
                  super(e, t),
                      (this._popper = null),
              ...
              _getPopperConfig() {
                  ...
                  return (
                      (this._inNavbar || this._config.display === "static") && (be.setDataAttribute(this._menu, "popper", "static"), (e.modifiers = [{ name: "applyStyles", enabled: !1 }])), { ...e, ...H(this._config.popperConfig, [e]) }
                  );
              }
              ...
              static clearMenus(e) {
                  ...
                  for (const i of t) {
                      ...
                      if (
                          ...
                          (o._menu.contains(e.target) && ((e.type === "keyup" && e.key === Ii) || /input|select|option|textarea|form/i.test(e.target.tagName)))
                      )
                          continue;
          ...
          const Vi = "backdrop",
              ...
              Hi = "show",
              ki = `mousedown.bs.${Vi}`,
              ea = { className: "modal-backdrop", clickCallback: null, isAnimated: !1, isVisible: !0, rootElement: "body" },
              ta = { className: "string", clickCallback: "(function|null)", isAnimated: "boolean", isVisible: "boolean", rootElement: "(element|string)" };
          class zi extends gt {
              constructor(e) {
          ...
          class Ki extends gt {
              ...
              activate() {
                  this._isActive ||
                      (this._config.autofocus && this._config.trapElement.focus(), x.off(document, Bt), x.on(document, ia, (e) => this._handleFocusin(e)), x.on(document, ra, (e) => this._handleKeydown(e)), (this._isActive = !0));
              }
              deactivate() {
          ...
          class He extends he {
              ...
              show(e) {
                  this._isShown ||
                      ...
                      ((this._isShown = !0), (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(Xi), this._adjustDialog(), this._backdrop.show(() => this._showElement(e)));
              }
              hide() {
                  !this._isShown ||
                      this._isTransitioning ||
                      x.trigger(this._element, pa).defaultPrevented ||
                      ((this._isShown = !1), (this._isTransitioning = !0), this._focustrap.deactivate(), this._element.classList.remove(Qi), this._queueCallback(() => this._hideModal(), this._element, this._isAnimated()));
              }
              dispose() {
          ...
          class we extends he {
              ...
              _initializeBackDrop() {
                  ...
                  return new zi({ className: Ca, isVisible: t, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: t ? e : null });
              }
              _initializeFocusTrap() {
                  return new Ki({ trapElement: this._element });
              }
          ...
          const Wa = "TemplateFactory",
              Ba = { allowList: rr, content: {}, extraClass: "", html: !1, sanitize: !0, sanitizeFn: null, template: "<div></div>" },
          ...
          const Xa = "tooltip",
              ...
              cl = "mouseenter",
              dl = "mouseleave",
              ul = { AUTO: "auto", TOP: "top", RIGHT: D() ? "left" : "right", BOTTOM: "bottom", LEFT: D() ? "right" : "left" },
              pl = {
                  allowList: rr,
                  animation: !0,
          ...
          return Dt(Ot), $(Ot), { Alert: vt, Button: xt, Carousel: et, Collapse: nt, Dropdown: fe, Modal: He, Offcanvas: we, Popover: Ut, ScrollSpy: Tt, Tab: Ke, Toast: Ot, Tooltip: ke };
      });
  })(Kn);
  var Or = Kn.exports;
  const Sr = zn(Or),
